...
def payment_page(request):
    booking_type = request.GET.get('type', 'unknown')
    return render(request, 'payment.html', {'booking_type': booking_type})

def payment_success(request):
    # Optional: You can log or print submitted dummy data
    return HttpResponse("<h2>Payment Successful! (Dummy)</h2><a href='/dashboard'>Back to Dashboard</a>")
